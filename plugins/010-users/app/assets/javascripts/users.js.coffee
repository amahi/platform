...
$ ->
  $(document)
    ...
    # new user
    .on 'ajax:success', '#new-user-form', (event, results) ->
      form = $(this)
      if results['errors']
        console.log results
    ...
    # delete a user
    .on "ajax:success", ".btn-delete", (event, results) ->
    ...
    .on "ajax:success", ".edit_name_form", (event, results) ->
    ...
    .on 'ajax:success', '.update-password', (event, results) ->
    ...
    .on 'ajax:complete', '.username-form', (event, results) ->
    	form = $(this)
    	link = form.prev()
    	form.hide "slow", ->
    		form.remove()
