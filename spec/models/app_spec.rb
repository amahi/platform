...
describe App do
  ...
  # FIXME : Think of better ways to write tests for container installation tests
  ...
  #     expect(app.webapp.get_conf).to include("#{35000+App.first.id}")
  #   end
  #
  ...
  #     expect {
  #       Docker::Container.get('mongo')
  #     }.to_not raise_error(Exception)
  #     # node container should be running
  #     expect {
  #       Docker::Container.get('node')
  #     }.to_not raise_error(Exception)
  #   end
  #
  #   # Test if a php5 app uninstalls correctly
  #   it "uninstalls correctly" do
  #     app = App.new("node") # Create an app object
  #     app.install_bg # Install it
  #     expect(App.count).to eq(1)
  #
  #     app.uninstall_bg
